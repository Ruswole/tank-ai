...
## Data Fetching
 ...
 Fetch is owned and shared projects server-side using the existing project data helper and pass both lists to the sidebar.
...
- redirect `/editor` if deleting the active workspace
- otherwise refresh 
