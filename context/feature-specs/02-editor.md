We need the best chrome components that frame every editor screen - the top navbar and the left sidebar shell. These will be reused in every chapter that follows.
