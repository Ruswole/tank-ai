...
1. Install Prisma CLI, Prisma Client, the SQL adapter, and the PostgreSQL driver pinned to the supported v7.6.0 release:

   ```bash
   npm install prisma@7.6.0 --save-dev
   npm install @prisma/client@7.6.0 @prisma/adapter-pg@7.6.0 pg
   ```
...
1. Generate Prisma Client via the locally installed package:
